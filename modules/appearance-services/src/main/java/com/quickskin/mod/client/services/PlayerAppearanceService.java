...
import com.quickskin.mod.client.api.SkinApplicationListener;
...
public class PlayerAppearanceService implements IPlayerAppearanceService, RemoteAppearanceTarget {
    ...
    private SkinApplicationListener skinApplicationListener;

    public void configureSkinListener(SkinApplicationListener listener) {
        if (skinApplicationListener != null) throw new IllegalStateException("Skin listener is already configured");
        skinApplicationListener = Objects.requireNonNull(listener, "listener");
    }
    ...
    public void applyLook(UUID playerId, @Nullable String skinId, @Nullable String capeId, @Nullable String model) {
        ...
        if (skinId != null) {
            ...
            if (skinLocation != null) {
                ...
                Objects.requireNonNull(skinApplicationListener, "Skin listener has not been configured")
                        .onSkinApplied(playerId, MinecraftTextures.reference(skinLocation));
            }
        ...
        if (!reloadingTransparency && !applyingNetworkUpdate && mc.player != null
            ...
            com.quickskin.mod.client.api.ClientNetworkApi.actions().syncAppearance(
                playerId,
