...
public final class ReplayModHelper {
    ...
    /**
     * Enables polling from the client's tick callback. Calling this twice is a no-op;
    ...
    public static void tick() {
        ...
        try {
            ...
            stopWatcher();
            QuickSkinInfo.LOGGER.debug("QuickSkin ReplayMod watcher stopped after a failure", error);
        }
    }
    ...
    private static synchronized void initializeReflection() {
        ...
        try {
            ...
            QuickSkinInfo.LOGGER.debug("QuickSkin could not bind ReplayMod's replay handler", error);
        }
    }
